...
/turf/open/floor/iron/elevated
	...
	smoothing_groups = SMOOTH_GROUP_CLOSED_TURFS + SMOOTH_GROUP_WALLS + SMOOTH_GROUP_ELEVATED_PLASTEEL
...
/turf/open/floor/iron/lowered
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_CLOSED_TURFS + SMOOTH_GROUP_WALLS + SMOOTH_GROUP_LOWERED_PLASTEEL
