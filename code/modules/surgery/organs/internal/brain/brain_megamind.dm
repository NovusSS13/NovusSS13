/obj/item/organ/brain/megamind
	name = "megamind"
	desc = "Oh you're a genius alright, just not a <b>super</b> one!"
	...
	organ_traits = list(TRAIT_ADVANCEDTOOLUSER, TRAIT_LITERATE, TRAIT_CAN_STRIP, TRAIT_SPECIAL_TRAUMA_BOOST, TRAIT_MEGAMIND, TRAIT_ANTIMAGIC_NO_SELFBLOCK, TRAIT_BIG_SKULL)
