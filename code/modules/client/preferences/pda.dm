...
/datum/preference/text/pda_ringtone/create_default_value(datum/preferences/preferences)
...
/datum/preference/text/pda_ringtone/is_accessible(datum/preferences/preferences)
...
/datum/preference/choiced/pda_theme/create_default_value(datum/preferences/preferences)
...
/datum/preference/choiced/pda_theme/is_accessible(datum/preferences/preferences)
	if(preferences.current_char_key != "main")
		return FALSE
	return ..()
