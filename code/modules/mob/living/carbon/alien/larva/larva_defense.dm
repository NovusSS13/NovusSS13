...
/mob/living/carbon/alien/larva/do_attack_animation(atom/attacked_atom, visual_effect_icon, obj/item/used_item, no_effect = FALSE, fov_effect = TRUE, angled = FALSE)
