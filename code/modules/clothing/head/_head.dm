/obj/item/clothing/head
	...
	worn_icon_avali = 'icons/mob/species/avali/clothing/head.dmi'
...
/obj/item/clothing/head/worn_overlays(mutable_appearance/standing, isinhands = FALSE)
	...
	if(HAS_TRAIT(src, TRAIT_COVERED_IN_FEMCUM))
		var/mutable_appearance/femcum = mutable_appearance('icons/effects/femcum.dmi', "helmetfemcum")
		femcum.color = COLOR_FEMCUM
		. += femcum
	if(HAS_TRAIT(src, TRAIT_COVERED_IN_CUM))
		var/mutable_appearance/cum = mutable_appearance('icons/effects/cum.dmi', "helmetcum")
		cum.color = COLOR_CUM
		. += cum
