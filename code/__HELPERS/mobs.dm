...
/proc/random_features()
	...
	return(list(
		...
		"tail" = "Cat",
		"tail_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
		"wings" = "None",
		"snout" = pick(GLOB.snouts_list),
		"snout_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
		"horns" = pick(GLOB.horns_list),
		"horns_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
		"frills" = pick(GLOB.frills_list),
		"frills_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
		"spines" = pick(GLOB.spines_list),
		"spines_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
		"ears" = "None",
		"ears_color" = "#[pick("7F","FF")][pick("7F","FF")][pick("7F","FF")]",
