...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_HEARTLESS_PUMPING" = TRAIT_HEARTLESS_PUMPING,
		...
		"TRAIT_CONSCIOUS_GRAB" = TRAIT_CONSCIOUS_GRAB,
		"TRAIT_EASILY_GRABBED" = TRAIT_EASILY_GRABBED,
		...
		"TRAIT_NO_BLOODY_HANDS" = TRAIT_NO_BLOODY_HANDS,
		"TRAIT_NO_BLOODY_SOLES" = TRAIT_NO_BLOODY_SOLES,
