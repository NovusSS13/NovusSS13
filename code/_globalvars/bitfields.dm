...
DEFINE_BITFIELD(bodytype, list(
	...
	"BODYTYPE_COMPRESSED" = BODYTYPE_COMPRESSED,
...
DEFINE_BITFIELD(external_bodytype, list(
	"BODYTYPE_ORGANIC" = BODYTYPE_ORGANIC,
	"BODYTYPE_ROBOTIC" = BODYTYPE_ROBOTIC,
	"BODYTYPE_HUMANOID" = BODYTYPE_HUMANOID,
	"BODYTYPE_MONKEY" = BODYTYPE_MONKEY,
...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_DIGITIGRADE_VARIATION_DISPLACEMENT" = CLOTHING_DIGITIGRADE_VARIATION_DISPLACEMENT,
))
...
DEFINE_BITFIELD(usage_flags, list(
	"INTERACTION_SELF" = INTERACTION_SELF,
	"INTERACTION_OTHER" = INTERACTION_OTHER,
))

DEFINE_BITFIELD(interaction_flags, list(
	"INTERACTION_AUDIBLE" = INTERACTION_AUDIBLE,
	"INTERACTION_COOLDOWN" = INTERACTION_COOLDOWN,
	"INTERACTION_SEX_COOLDOWN" = INTERACTION_SEX_COOLDOWN,
	"INTERACTION_USER_LUST" = INTERACTION_USER_LUST,
	"INTERACTION_TARGET_LUST" = INTERACTION_TARGET_LUST,
	"INTERACTION_USER_CLIMAX" = INTERACTION_USER_CLIMAX,
	"INTERACTION_TARGET_CLIMAX" = INTERACTION_TARGET_CLIMAX,
))
