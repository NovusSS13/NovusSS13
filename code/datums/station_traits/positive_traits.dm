...
/datum/station_trait/cybernetic_revolution
	...
	var/static/list/job_to_cybernetic = list(
		...
		/datum/job/curator = /obj/item/organ/eyes/cybernetic/glow,
		...
		/datum/job/head_of_personnel = /obj/item/organ/eyes/cybernetic,
		/datum/job/head_of_security = /obj/item/organ/eyes/cybernetic/thermals,
		/datum/job/janitor = /obj/item/organ/eyes/cybernetic/xray,
		/datum/job/lawyer = /obj/item/organ/heart/cybernetic/tier2,
		/datum/job/mime = /obj/item/organ/tongue/cybernetic, //...
		/datum/job/paramedic = /obj/item/organ/cyberimp/eyes/hud/medical,
		/datum/job/prisoner = /obj/item/organ/eyes/cybernetic/shield,
