...
DEFINE_BITFIELD(check_flags, list(
	"AB_CHECK_HANDS_BLOCKED" = AB_CHECK_HANDS_BLOCKED,
	"AB_CHECK_IMMOBILE" = AB_CHECK_IMMOBILE,
	"AB_CHECK_LYING" = AB_CHECK_LYING,
	"AB_CHECK_CONSCIOUS" = AB_CHECK_CONSCIOUS,
	"AB_CHECK_INCAPACITATED" = AB_CHECK_INCAPACITATED,
))
