...
#define DNA_PENIS_SIZE_BLOCK 17
#define DNA_TESTICLES_SHAPE_BLOCK 18
#define DNA_VAGINA_SHAPE_BLOCK 19
#define DNA_BREASTS_SHAPE_BLOCK 20
#define DNA_BREASTS_SIZE_BLOCK 21
