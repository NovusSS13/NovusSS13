...
export const MESSAGE_TYPE_BALLOON = 'balloon';
...
export const MESSAGE_TYPES = [
  ...
  // Basic types
  {
    ...
    selector: '.say, .emote, .horny, .love, .userlove',
  },
  {
    ...
    selector:
      '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .comradio, .secradio, .gangradio, .engradio, .medradio, .sciradio, .suppradio, .servradio, .radio, .deptradio, .binarysay, .newscaster, .resonate, .abductor, .alien, .changeling, .brother',
  },
  {
    type: MESSAGE_TYPE_BALLOON,
    name: 'Balloon Alerts',
    description: 'Floating messages that get repeated in chat.',
    selector: '.balloon_block, .balloontitle',
  },
  {
    ...
    selector:
      '.notice:not(.pm), .adminnotice, .info, .sinister, .cult, .infoplain, .announce, .hear, .smallnotice, .holoparasite, .boldnotice, .examine_block',
  },
  {
  ...
  },
  {
    ...
    name: 'LOOC',
    description: 'Local OOC messages viewable by nearby players',
